...
<a href="/docs/nuget">Read more about NuGet support</a>
...
<a href="/docs/parallel-testing">Read more about parallel testing</a>
...
<p style="margin:2rem 0;"><a style="font-size:14pt;color:#fff;text-decoration:none;background-color:#2cba2c;padding:.7rem 2rem;border-radius:4px;" href="/pricing">Sign up now</a></p>
...
<h2>Documentation</h2>
<a href="/docs">https://www.appveyor.com/docs</a>
<h2>Dicsussions</h2>
